...
export const LabelLogin = styled.p`
  color: ${props => (props.isDarkLightMode ? '#ffffff' : '#909090')};
  font-weight: bold;
  font-size: 0.8rem;
`
export const LoginFormContainer = styled.div`
  background-color: ${props => (props.isDarkLightMode ? '#181818' : '#ffffff')};
  display: flex;
...
export const FormContainer = styled.form`
  ...
  padding: 20px;
  border-radius: 8px;
  background-color: ${props => (props.isDarkLightMode ? '#000000' : '#ffffff')};
  width: 100%;
  max-width: 400px;
...
export const CheckboxField = styled.input`
  ...
  height: 20px;
`
export const ShowPwdField = styled.p`
  font-size: 1rem;
  font-weight: 500;
